...
solver_lp = IpoptSolver(print_level=0, linear_solver="ma57")
...
p_error[ii] = linear_approximations[1]["error"]
q_error[ii] = linear_approximations[2]["error"]
end
