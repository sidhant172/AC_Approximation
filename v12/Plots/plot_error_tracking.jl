...
# plot!(nlp_err[2:end], xlabel = "Iteration number", linestyle =:dash, ylabel="Maximum approximation error",xtickfont = font(10, "Courier"), linewidth=2, lab="Line 1 Reactive", subplot=1, right_margin=40px, left_margin=20px, top_margin= 30px, bottom_margin=10px)
# # plot!(nlp_err)
# plot!(lp_err, xlabel = "Iteration number", linestyle = :dash, ylabel="LP Objective", xtickfont = font(10, "Courier"), linewidth=2, lab="Line 1 Reactive", subplot=2, right_margin=40px, left_margin=20px, top_margin= 30px, bottom_margin=10px)
# #
...
# plot!(lp_err[ind_phase1:end], xlabel = "Iteration number", ylabel="Objective of LP relaxation", xtickfont = font(10, "Courier"),color=:red, linewidth=2, leg=false, subplot=4, right_margin=40px, left_margin=20px, top_margin= 30px, bottom_margin=10px)
